<div class="wblock1" style="padding: 10px; margin-bottom: 10px; width:100%; overflow-x: hidden;">
    ...
    <p>
        ...
        <br><br>
        Website MAIN:
        <a href="/" target="_blank"><?=$GLOBALS['config']['Website']['base_url']?></a>
        <br>
        GitHub Link:
        <a href="https://github.com/torrison1/inside4sandbox" target="_blank">https://github.com/torrison1/inside4sandbox</a>
        <br>
        Database:
        <a href="/inside/panel/database" target="_blank"><?=$GLOBALS['config']['Website']['base_url']?>/inside/panel/database</a>
        <br>
        Project Files:
        <a href="/inside/panel/projectfiles" target="_blank"><?=$GLOBALS['config']['Website']['base_url']?>/inside/panel/projectfiles</a>
        <br>
        ...
        <a href="/inside/auto/table/inside_top_menu" target="_blank">/inside/auto/table/inside_top_menu</a>
        <br>

        Modules Table:
        <a href="/inside/auto/table/inside_modules" target="_blank">/inside/auto/table/inside_modules</a>
        <br>
...
<script>
    $(function(){
        ...
        $('.open_module_info_btn').on('click', function(){
            ...
            if (block.html() == '') {
                $.get('/inside/modules/module_info/?system_name='+module_system_name, function(data){
