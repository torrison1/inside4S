...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#inside_terminal').on('click', '.mobile_del_btn', function (e) {
            ...
            // Make Dialog
            $("<div cell_id='" + mob_line_id + "'><form method='post' action='/inside/auto/del_request/?table_name=" + global_pdg_table + "' dialog_id=" + dialog_id + ">" + text + input + button + "</form></div>").dialog({
                autoOpen: true,
                title: 'Delete fields',
                width: 300,
                height: 200,
        ...
        $(".pdg_bdel").on('click', function () {
            ...
            // Make Dialog
            $("<div cell_id='" + this.value + "'><form method='post' action='/inside/auto/del_request/?table_name=" + global_pdg_table + "' dialog_id=" + dialog_id + ">" + text + input + button + "</form></div>").dialog({
                autoOpen: true,
                title: 'Delete fields',
                width: 300,
                height: 200,
    ...
    function open_add_dialog(pdg_table) {
        ...
        $.post('/inside/auto/add_dialog/', array, function (data) {
            // Add new AJAX Data
    ...
    function open_copy_dialog(tmp_line_id, pdg_table) {
        ...
        $.post('/inside/auto/add_dialog/' + tmp_line_id, array, function (data) {
            // Add new AJAX Data
            $('div[dialog_id=' + dialog_id + ']').html(data);
            // Activate Tabs
            $("#cell_tabs_" + dialog_id).tabs();
    ...
    function update_edit_dialog(tmp_line_id, dialog_id, pdg_table) {
        ...
        // AJAX load information
        var array = {cell_id: tmp_line_id, pdg_table: pdg_table, dialog_id: dialog_id};
        $.post('/inside/auto/edit_dialog/', array, function (data) {
            $('div[dialog_id=' + dialog_id + ']').html(data);
