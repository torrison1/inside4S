            ...
            <div class="mt-3">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= $lang_link_prefix ?>/content/info/feed">Content</a></li>
    ...
    <div class="container">
        ...
        <section class="col-md-3 category_tags_list">
            ...
            <div class="wblock1 p-3 content_filters">
                <h4><a href="<?= $lang_link_prefix ?>/content/info/feed">Content</a></h4>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-5 col-md-5 it-product-bg">
                            <div class="product-img">
                                <a href="<?= $lang_link_prefix ?>/content/info/page/<?= $page['content_alias'] ?>">
                        ...
                        <div class="col-sm-12 col-lg-7 col-md-7">
                            ...
                            <h2 class="heading-left it-tw-6 content-name"><a
                                    href="<?= $lang_link_prefix ?>/content/info/page/<?= $page['content_alias'] ?>"><?= $page['content_name'] ?></a>
                            </h2>
                            ...
                            <div>
                                <a href="<?= $lang_link_prefix ?>/content/info/page/<?= $page['content_alias'] ?>" >More... &#8594;</a>
                            </div>
                        </div>
                    </div>
                </div>
