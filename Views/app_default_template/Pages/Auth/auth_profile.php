                ...
                <ul class="list-group text-center">
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="mt-3">
                            ...
                            <a class="btn btn-primary w_full mb-3" target="_blank" href="<?=$lang_link_prefix?>/inside/panel/admin">Inside Admin Panel &gt;&gt;</a>
                            <?php } ?>
                        ...
                        <div>
                            <a title="LogOut" href="<?=$lang_link_prefix?>/auth/page/logout">Logout from profile</a>
                        </div>
                    </li>
                </ul>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div>
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <form action="/auth/api/edit_info/" method="post" id="update_info_form" class="style_form form-inline" enctype="multipart/form-data">
                                ...
                                <div class="col-md-9">
                                    <select class="wbgs1 form-control lang_select" name="lang" onchange="location.href = $(this).val();">
                                        <?php foreach ($t->getLanguages() as $lang) {
                                            ?>
                                            <option value="/<?=$lang['lang_alias']?><?=$GLOBALS['app']['routing']['clear_uri']?>" lang="<?=$lang['lang_alias']?>"<?php if ($lang['lang_alias'] == $GLOBALS['app']['translate']['active_language']) echo " selected";?>>
