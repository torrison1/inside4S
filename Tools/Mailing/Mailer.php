...
class Mailer {
    ...
    public function init() {
        ...
        $this->from_email = $GLOBALS['config']['Mailer']['from_email'];
        $this->from_name = $GLOBALS['config']['Mailer']['from_name'];
        $this->mail_password = $GLOBALS['config']['Mailer']['mail_password'];
