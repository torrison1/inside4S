    ...
    public function view($to_var = true) {
        ...
        if (isset($result[0])) {
            ...
            foreach ($result as $row) {
                ...
                $table_class = "\\Tools\\InsideAutoTables\\Tables\\".ucfirst($row['Table']);
                ...
                if ($table === $row['Table']) {
                    ...
                    echo "<td>$table_i. <a href='{$system_root_url}/inside/auto/table/$rowTable'>$rowTable</a></td>
                            <td>№</td>
                            <td>Name</td>
                            <td>Type</td>
                            <td>Default</td>
