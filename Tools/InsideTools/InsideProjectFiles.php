...
Class InsideProjectFiles {
    ...
    public function view($to_var = true) {
        ...
        $path = str_replace('/Tools/InsideTools/InsideProjectFiles.php','', __FILE__);
    ...
    private function read_dir_content($parent_dir, $depth = 0){
        ...
        $dir_view = str_replace('/home/ikiev/ikiev.biz/chatbots/','',$parent_dir );
        ...
        if (isset($this->modules_files[$dir_view]))
            $str_result .= " <a style='color: darkgreen' href='/inside/modules/module/?system_name=".$this->modules_files[$dir_view]['module_system_name']."'> +++ ".$this->modules_files[$dir_view]['module_name']."</a>";
        ...
        if ($handle = opendir($parent_dir))
        {
            while (false !== ($file = readdir($handle)))
            {
                ...
                if( is_dir($parent_dir . "/" . $file) ){
                    ...
                    $modules = '';
                    if (isset($this->modules_files[$file_full])) $modules = " <a style='color: darkgreen' href='/inside/modules/module/?system_name=".$this->modules_files[$file_full]['module_system_name']."'> +++ ".$this->modules_files[$file_full]['module_name']."</a>";
