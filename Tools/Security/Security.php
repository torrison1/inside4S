...
Class Security
{
    ...
    function init() {
        $this->encryption_salt1 = $GLOBALS['config']['Security']['encryption_salt1'];
        $this->encryption_salt2 = $GLOBALS['config']['Security']['encryption_salt2'];
        $this->encryption_salt_length = $GLOBALS['config']['Security']['encryption_salt_length'];
        $this->encryption_aes_key = $GLOBALS['config']['Security']['encryption_aes_key'];
        $this->encryption_iv_static = $GLOBALS['config']['Security']['encryption_iv_static'];
        $this->csrf_token_key = $GLOBALS['config']['Security']['csrf_token_key'];
        $this->csrf_token_salt = $GLOBALS['config']['Security']['csrf_token_salt'];
    }
    ...
    function check_csfr_token($user_id) {
        if (!isset($_POST['csrf_token'])) $_POST['csrf_token'] = '0000000000000000';
