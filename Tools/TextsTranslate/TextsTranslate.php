...
namespace Tools\TextsTranslate;
...
Class TextsTranslate {
    ...
    public function init(){
        ...
        $this->defaultLanguage = $GLOBALS['config']['Translate']['default_lang'];

        if ($GLOBALS['app']['translate']['uri_prefix_value'] != '') {
            foreach ($this->getLanguages() as $lang) {
                if ($GLOBALS['app']['translate']['uri_prefix_value'] == $lang['lang_alias']) $this->activeLanguage = $lang['lang_alias'];
            }
        } else {
            $this->activeLanguage = $this->defaultLanguage;
        }
        $GLOBALS['app']['translate']['active_language'] = $this->activeLanguage;
        ...
        // if ($GLOBALS['app']['translate']['uri_prefix_value'] == '') $GLOBALS['Commons']['lang'] = $this->defaultLanguage;
        // $GLOBALS['Commons']['lang'] = str_replace('/', '', $GLOBALS['app']['translate']['uri_prefix_value']);
