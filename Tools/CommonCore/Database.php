...
Class Database
{
    ...
    function init() {
        ...
        $this->db_host = $GLOBALS['config']['Database']['db_host'];
        $this->db_database = $GLOBALS['config']['Database']['db_database'];
        $this->db_user = $GLOBALS['config']['Database']['db_user'];
        $this->db_password = $GLOBALS['config']['Database']['db_password'];
