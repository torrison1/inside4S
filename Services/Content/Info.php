...
Class Info extends \Tools\CommonCore\SmartWebsiteService
{
    ...
    public function feed($page = false, $filter_type = false, $alias = false) {
        ...
        if ($page == 1) $this->website->redirect_301 ($this->data['lang_link_prefix'].'/content/info/feed');
        if (!$page) $page = 1;

        $info_system = new \Tools\Content\Info_system;
        ...
        if (!$filter_type) {
            ...
            $this->data['page_uri'] = '/content/info/feed';
