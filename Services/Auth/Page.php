...
Class Page extends \Tools\CommonCore\SmartWebsiteService {
    ...
    //i--- User Profile Page: /auth/page/profile page ; inside_auth ; torrison ; 01.05.2020 ; 2 ---/
    ...
    //i--- Logout links: /auth/page/logout, /auth/off links ; inside_auth ; torrison ; 01.05.2020 ; 3 ---/
    ...
    public function facebook_redirect(){
        ...
        echo $res['message']."<br>";
        if ($res['login_type'] == 'register') $redirect_link = '/auth/page/profile?reg=1';
        else $redirect_link = $GLOBALS['inside4']['translate']['uri_prefix'].'/auth/page/profile';
        $this->website->redirect_refresh($redirect_link);
