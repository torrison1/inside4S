...
Class Panel extends \Tools\CommonCore\SmartWebsiteService
{
    ...
    public function index() {
        $this->website->redirect_refresh('/inside/panel/admin');
    }
    ...
    public function admin() {
        ...
        $modules_system = new \Tools\InsideTools\InsideModularSystem;
    ...
    public function table($table_name) {
        ...
        $this->website->redirect_refresh('/inside/auto/table/'.$table_name);
